...
# Tested this twice, got Austin twice once, and myself once
# Put something in place to prevent that
print("< " + UserName + "> Hi")
time.sleep(2)
print("< " + random.choice(users) + "> Hello " + UserName)
print("< " + random.choice(users) + "> Hi")
...
def code():
	...
	print('< everyone else> ...')
	print('< dampeoples> something something smartass-like')
